...
const About = () => (
    <Section id="about" title="Our Story">
        <div className="max-w-4xl mx-auto space-y-8 text-lg font-light">
            ...
            <p>
                Our culinary philosophy centers on **fresh, seasonal ingredients** sourced from trusted local producers. Every dish, from our signature Chicken Wellington to our carefully crafted coffee, is prepared with meticulous attention to detail, ensuring a burst of authentic, gourmet flavor in every bite.
            </p>
            <p>
...
const MenuHighlights = () => {
    const highlights = [
        { name: "Royal Chicken Wellington", desc: "Tender fillet mignon, mushroom duxelles, prosciutto, flaky pastry.", price: "$45", icon: "🍴" },
...
const Testimonials = () => {
    const testimonials = [
        ...
        { quote: "The Royal Chicken Wellington is a must-try. The service was impeccable, and the kids loved it too.", name: "David M.", rating: 5 },
...
const Gallery = () => {
    const galleryItems = [
        ...
        { ratio: '4/3', alt: 'Plated gourmet dish, Royal Chicken Wellington', keywords: 'plated gourmet dishes' },
